            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 flex items-center">
                        <form method="POST" action="{{ route('team-invitations.accept-with-confirmation', $invitation) }}">
                            @csrf
                            <x-button>
                        ...
                        <form method="POST" action="{{ route('team-invitations.decline', $invitation) }}" class="ml-3">
                            @csrf
